...
struct StorybookTypography {
    ...
    static var headingMultiline: some View {
        VStack(alignment: .leading, spacing: .xSmall) {
            ...
            Separator()
                .padding(.vertical, .small)
            heading("Title 1 with a very large and multine content", style: .h1)
            heading("Title 2 with a very very large and multine content", style: .h2)
            heading("Title 3 with a very very very very large and multine content", style: .h3)
            heading("Title 4 with a very very very very large and multine content", style: .h4)
