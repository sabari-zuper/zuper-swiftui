...
public extension TimelineStep where Header == TimelineStepBadgeText {
    ...
    /// Creates Zuper TimelineStep component with custom details.
    init(
        _ label: String,
        sublabel: String = "",
...
public extension TimelineStep where Content == TimelineStepBottomText {
    ...
    /// Creates Zuper TimelineStep component with custom header and text details.
    /// - Parameters:
...
public extension TimelineStep where Header == TimelineStepBadgeText, Content == TimelineStepBottomText {
    ...
    /// Creates Zuper TimelineStep component with text details.
...
public enum TimelineStepStyle: Equatable {
    ...
    public var iconSymbol: Icon.Content {
        ...
        case .status(.success):     return .sfSymbol("checkmark.circle.fill", color: color)
        case .status(.warning):     return .sfSymbol("exclamationmark.circle.fill", color: nil)
        case .status(.critical):    return .sfSymbol("xmark.circle.fill", color: color)
        case .status(.info):        return .sfSymbol("checkmark", color: color)
        }
    }
