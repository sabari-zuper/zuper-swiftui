...
public extension Label {
    ...
    /// Creates Zuper Label component.
    init(
        _ title: String = "",
        icon: Icon.Content = .sfSymbol("", color: .clear),
...
struct LabelPreviews: PreviewProvider {
    ...
    @ViewBuilder static var snapshots: some View {
        VStack(alignment: .leading, spacing: .large) {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                Label("Label", icon: gridIcon, style: .title1)
                Label("Label", icon: gridIcon, style: .text(.small))
    ...
    @ViewBuilder static var snapshotLabelLayout: some View {
        HStack(alignment: .firstTextBaseline, spacing: .xxSmall) {
            VStack(alignment: .leading, spacing: .xSmall) {
                Label("Label with long multiline text", icon: gridIcon, style: .title2)
    ...
    static var snapshotColorOverride: some View {
        VStack(alignment: .leading, spacing: .xxxSmall) {
            Label("Zuper Icon", icon: .sfSymbol("circle", color: .red), style: .heading(.title5, color: .none))
