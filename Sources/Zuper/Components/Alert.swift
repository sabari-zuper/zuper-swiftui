...
public struct Alert<Content: View>: View {
    ...
    var primaryButtonStyle: Zuper.Button.Style {
        .status(status, subtle: false)
    }

    var secondaryButtonStyle: Zuper.Button.Style {
        isSuppressed
            ? .secondary
...
public extension Alert {
    ...
    /// Creates Zuper Alert component including custom content.
    init(
        _ title: String = "",
        description: String = "",
...
struct AlertPreviews: PreviewProvider {
    ...
    static func alert(_ title: String, status: Status, icon: Icon.Content, isSuppressed: Bool) -> some View {
        Alert(
            title,
            description: description,
            icon: icon,
    ...
    static func alerts(showIcons: Bool, isSuppressed: Bool) -> some View {
        VStack(spacing: .medium) {
            alert("Informational message", status: .info, icon: showIcons ? .infoCircle : .none, isSuppressed: isSuppressed)
    ...
    static var primaryButtonOnly: some View {
        VStack(spacing: .medium) {
            Alert(title, description: description, icon: .infoCircle, buttons: Self.primaryConfiguration)
            Alert(description: description, icon: .infoCircle, buttons: Self.primaryConfiguration)
            ...
            Alert( title, icon: .infoCircle, buttons: Self.primaryConfiguration)
            Alert(title, buttons: Self.primaryConfiguration)
            Alert(icon: .infoCircle, buttons: Self.primaryConfiguration)
    ...
    static var noButtons: some View {
        VStack(spacing: .medium) {
            Alert(title, description: description, icon: .infoCircle)
