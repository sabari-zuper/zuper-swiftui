...
public extension ZText {
    typealias Size = TextSize
    typealias Color = TextColor
}

// MARK: - Inits
public extension ZText {
    
    /// Creates Zuper Text component that displays a string literal.
    ///
    /// - Parameters:
...
extension ZText: TextRepresentable {
...
struct TextPreviews: PreviewProvider {
    ...
    @ViewBuilder static var storybook: some View {
        VStack(alignment: .leading, spacing: .medium) {
            Group {
                ...
                ZText("Text <ref>*</ref>", accentColor: .redNormal)
    ...
    static var custom: some View {
        VStack(alignment: .leading, spacing: .medium) {
            Group {
                ZText("Text custom size", size: .custom(5))
                ZText("Text custom size", size: .custom(21))
                
                ZText("Text <strong>formatted</strong> custom size", size: .custom(5))
                ZText("Text <strong>formatted</strong> custom size", size: .custom(21))
                
                ZText("Text <applink1>TextLink</applink1> custom size", size: .custom(5))
                ZText("Text <applink1>TextLink</applink1> custom size", size: .custom(21))
                Separator()
            }
    ...
    static var attributedTextSnapshots: some View {
        VStack(alignment: .leading, spacing: .medium) {
            ZText("An <ref>attributed</ref> text <a href=\"..\">link</a>", accentColor: .orangeNormal)
    ...
    @ViewBuilder static func text(_ content: String, size: TextSize, weight: Font.Weight) -> some View {
